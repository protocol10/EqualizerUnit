...
public class MainActivity extends Activity implements OnSeekBarChangeListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		eq.setBandLevel((short)0, (short)500);
		eq.setBandLevel((short)1, (short)100);
		eq.setBandLevel((short)2, (short)900);
		eq.setBandLevel((short)3, (short)300);
		eq.setBandLevel((short)4, (short)000);
	...
	public void onProgressChanged(SeekBar arg0, int progress, boolean arg2) {
		...
		case R.id.seekBar2:
			...
			Toast.makeText(getApplicationContext(), "Seekbar2", Toast.LENGTH_SHORT).show();
			break;
		case R.id.seekBar3:
			progress=progress-index;
			db=progress*100;
